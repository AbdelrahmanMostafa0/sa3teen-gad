  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 transition-colors duration-300">
        <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-8">
          ...
          <div className="hidden md:flex items-center gap-3 md:gap-6">
            ...
            <ModeToggle />
            <Link href="/tasks" className="text-2xl hover:text-primary transition-colors">
              <FiCheckSquare />
            </Link>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 border-t border-border/40 bg-background/95 backdrop-blur flex justify-around py-3">
        ...
        <Link href="/tasks" className="flex flex-col items-center text-primary hover:text-primary/80 transition-colors">
          <FiCheckSquare className="w-6 h-6" />
          <span className="text-xs mt-1">المهام</span>
        </Link>
<Link href="/" className="flex flex-col items-center text-primary hover:text-primary/80 transition-colors">
          <Home className="w-6 h-6" />
          <span className="text-xs mt-1">الرئيسية</span>
        </Link>
        <Link href="/settings" className="flex flex-col items-center text-primary hover:text-primary/80 transition-colors">
